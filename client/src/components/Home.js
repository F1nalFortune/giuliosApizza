    ...
    return(
        ...
        <div>
          <div className='center'>
            ...
            <img id='hosts' src="https://lh3.google.com/u/0/d/1hxO_La8jmH1Kb8FSOxEQ3DBOSXNRGO2x=w2560-h1218-iv1" alt="homescreen"/>
            <p>Your Hosts,<br/>The Gagliardi Family</p>
            <p>203-239-3515</p>
            <p>email: giuliospizza87@gmail.com</p>
            <i className="fas fa-map-marker-alt  fa-lg"></i>
            <p>126 Middletown Ave, North Haven, CT 06473</p>
          </div>
            <div id='map'>
              <Map/>
            </div>
